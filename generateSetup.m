...
%Emil Bjornson, Luca Sanguinetti, "Making Cell-Free Massive MIMOCompetitive With MMSE Processing and Centralized Implementation,"
%IEEE Transactions on Wireless Communications, To appear. Download article: https://arxiv.org/abs/1903.10611
%% INPUT:
...
%                     between AP l and UE k in setup n, normalized by noise power
...
for n = 1:nbrOfSetups    
    ...
    %Random UE locations with uniform distribution with K/nbrBSs in the %coverage area of each cellular BS
    ...
    while min(nbrOfUEsPerBS)<tau_p        
        ...
        if nbrOfUEs>0            
            ...
            %Compute conditional mean and standard deviation necessary to obtain the new shadow 
            %fading realizations, when the previous UEs' shadow fading realization have already been 
            %generated.This computation is based on Theorem 10.2 in "Fundamentals of Statistical Signal Processing: Estimation Theory" by S. Kay
